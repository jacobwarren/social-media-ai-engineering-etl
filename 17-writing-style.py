...
def main(input_file: str,
    ...
    if run_id:
        _, std_output_path, run_id = resolve_io(stage="17-writing-style", run_id=run_id, base_dir=base_dir, explicit_in=input_file, prior_stage=None, std_name=ArtifactNames.STAGE17_STYLE)
